...
$arJSCoreConfig = array(
	...
	'jquery' => array(
      ...
      '/bitrix/js/main/jquery/jquery-migrate.min.js',
    ),
		'skip_core' => true,
	),
	'jquery_src' => array(
		'js' => array(
      '/bitrix/js/main/jquery/jquery-1.12.4.js',
      '/bitrix/js/main/jquery/jquery-migrate.js',
    ),
		'skip_core' => true,
	),
	'jquery2' => array(
	...
	'jquery2_src' => array(
		'js' => array(
      '/bitrix/js/main/jquery/jquery-2.2.4.js',
      '/bitrix/js/main/jquery/jquery-migrate.js',
    ),
		'skip_core' => true,
	),
	'jquery3' => array(
		'js' => array(
      '/bitrix/js/main/jquery/jquery-3.6.0.min.js',
      '/bitrix/js/main/jquery/jquery-migrate.min.js',
    ),
		'skip_core' => true,
	),
	'jquery3_src' => array(
		'js' => array(
      '/bitrix/js/main/jquery/jquery-3.6.0.js',
      '/bitrix/js/main/jquery/jquery-migrate.js',
    ),
		'skip_core' => true,
	),
