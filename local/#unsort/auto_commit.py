...
# crontab -e
# add line -> @midnight /[path]/auto-commit.py
...
if not os.path.exists('/home/m/mtbspb/mtb.spb.ru/public_html/!mit'):
  result = check_repository_status('/home/m/mtbspb/mtb.spb.ru/public_html')
  print(result)
else:
  print(0)